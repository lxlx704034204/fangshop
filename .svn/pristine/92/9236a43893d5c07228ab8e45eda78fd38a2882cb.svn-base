...
public class Product extends PageModel{
	...
	private int id;//商品ID 自增
	private String name;//商品名称 
	private String introduce;//商品介绍 
	private BigDecimal price;//定价 
	private BigDecimal nowPrice;//现在的价格 
	...
	private String productHtml;//商品描述
	private String maxPicture;//大图地址
	...
	private String catalogID;//商品类别ID
