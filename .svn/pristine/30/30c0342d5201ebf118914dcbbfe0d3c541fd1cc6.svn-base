...
<body>
    <div id="wrapper">
        <!-- Navigation -->
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;background-color:#1c94c4;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand"  href="${basepath}/manage/user/home" style="color:white">FangShop --- 交易管理系统</a>
            </div>
			<ul class="nav navbar-top-links navbar-right">
                <li><a href="" target="_blank"><i class="glyphicon glyphicon-globe" style="color:white">访问站点</i></a></li>
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color:white">
                        <i class="fa fa-user fa-fw"></i> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="${basepath}/manage/user/show?account=''" target="_blank"><i class="fa fa-user fa-fw"></i> 用户信息</a>
                        </li>
