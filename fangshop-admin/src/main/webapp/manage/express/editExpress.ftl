...
<table style="width:30%;margin-left:auto;margin-right:auto;border:1px solid #EBEBEB;">
    <thead>
    <tr>
        <th colspan=2 style="text-align:center;background-color:#DFF1D9;">编辑</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        ...
        <td class="td-text">
            <div class="input-group">
                <#if express.code??>
                    <input type="text" id="code" name="code" class="form-control"  aria-describedby="basic-addon1" value="${express.code}">
                <#else>
    ...
    <tr>
        ...
        <td class="td-text">
            <div class="input-group">
                <#if express.name??>
                    <input type="text" id="name" name="name" class="form-control"  aria-describedby="basic-addon1" value="${express.name}">
                <#else>
    ...
    <tr>
        ...
        <td class="td-text">
            <div class="input-group">
                <#if express.fee??>
                    <input type="text"  id="fee" name="fee" class="form-control"  aria-describedby="basic-addon1" value="${express.fee}">
                <#else>
    ...
    <tr>
        ...
        <td class="td-text">
            <div class="input-group">
                <#if express.order1??>
                    <input type="text"  id="order" name="order" class="form-control"  aria-describedby="basic-addon1" value="${express.order1}">
                <#else>
    ...
    <tr>
        <td colspan=2 style="text-align:center;">
            <button type="submit" id="btnSave"  class="btn btn-success">修改</button>
        </td>
    </tr>
    </tbody>
</table>
<script type="text/javascript">
    ...
    function save(){
        ...
        data = data + "&id=" + encodeURI(${express.id});
        ...
        $.ajax({
            async : true,
            type : "POST",
            url : "${basepath}/manage/express/update",
            cache : false,
            timeout : 60 * 60 * 1000,
            dataType : "json",
            data : data,
