...
public class SystemSetting implements Serializable {
    ...
    /** t_systemsetting.systemCode */
    private String systemcode;

    /** t_systemsetting.name */
    private String name;
    ...
    /** t_systemsetting.title */
    private String title;

    /** t_systemsetting.description */
    private String description;

    /** t_systemsetting.keywords */
    private String keywords;

    /** t_systemsetting.shortcuticon */
    private String shortcuticon;

    /** t_systemsetting.address */
    private String address;

    /** t_systemsetting.tel */
    private String tel;

    /** t_systemsetting.email */
    private String email;

    /** t_systemsetting.icp */
    private String icp;

    /** t_systemsetting.isopen */
    private String isopen;

    /** t_systemsetting.closeMsg */
    private String closemsg;

    /** t_systemsetting.qq */
    private String qq;

    /** t_systemsetting.imageRootPath */
    private String imagerootpath;

    /** t_systemsetting.manageHttp */
    private String managehttp;

    /** t_systemsetting.defaultProductImg */
    private String defaultproductimg;

    /** t_systemsetting.style */
    private String style;

    /** t_systemsetting.version */
    private String version;

    /** t_systemsetting.manageLeftTreeLeafIcon */
    private String managelefttreeleaficon;

    /** t_systemsetting.statisticsCode */
    private String statisticscode;

    /** t_systemsetting.openResponsive */
    private String openresponsive;

    /** t_systemsetting.qqHelpHtml */
    private String qqhelphtml;

    /** t_systemsetting.images */
