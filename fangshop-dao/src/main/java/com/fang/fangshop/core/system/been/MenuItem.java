...
/**
 * 页面上显示的菜单项，每一个MenuItem对应一个节点页面上显示的菜单项，每一个MenuItem对应一个节点
 * @author wangyantao
 *
 */
public class MenuItem {
	private Integer id;// 0：根节点，否则是子节点
...
//            if(this.getType().equals(MenuType.page) || this.getType().equals(MenuType.button)){
