...
@RedisCache
public class News extends PageModel implements Serializable {
	@RedisFieldNotCache
	private static final String className = "news";
	@RedisFieldNotCache
	...
	public News(Integer id, String type, String title, String title2,String content, Date createtime, Date updatetime,
			Integer readercount, String status, String catalogid, String lableid, String createaccount, Integer order1,
			String code) {
		super();
		this.id = id;
		this.type = type;
